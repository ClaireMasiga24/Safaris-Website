          ...
          <div className="flex items-center space-x-4">
            <div>
              ...
              <div className="flex items-center space-x-1">
                ...
                {[...Array(4)].map((_, i) => (
                  <svg key={`google-full-${i}`} className="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="flex items-center space-x-4">
            <div>
              ...
              <div className="flex items-center space-x-1">
                {/* 5 filled circles */}
                {[...Array(5)].map((_, i) => (
                  <svg key={`tripadvisor-circle-${i}`} className="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
